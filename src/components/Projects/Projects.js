        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={6} className="ecommerce">
            <ProjectCard
              ...
              isBlog={false}
              title="ecommerce"
              description="Engineered a dynamic blogging platform that allows users to post and manage content. 
                     Implemented server-side logic using Node.js and Express.js, providing a robust backend foundation for content 
                     management"
